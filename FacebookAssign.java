/*Assignment 1: Access different elements on Facebook website using advanced xpath
* 1: Finding signup button in Facebook by using child xpath.
* 2: Locate the first name field from Signup button in Facebook using Parent xpath.
* 3: Identify the password field from mobile number field by using following method
* 4: Locate mobile number from new password field by using preceding approach. */
package Assignment1;
