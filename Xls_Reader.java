...
public class Xls_Reader {
    ...
    private static final CellType CELL_TYPE_NUMERIC = null ;
    private static final CellType CELL_TYPE_BLANK = null ;
    private static final CellType CELL_TYPE_FORMULA = null ;
    public String path;
...
//
    ...
    public String getCellData(String sheetName, int colNum, int rowNum) {
        try {
            ...
            return cell.getStringCellValue();
//            else if (cell.getCellType() == CELL_TYPE_NUMERIC || cell.getCellType() == CELL_TYPE_FORMULA) {
//
//                String cellText = String.valueOf(cell.getNumericCellValue());
